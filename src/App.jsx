...
const SECTION_IMAGES = [
  "/model/bg1.webp", "/model/glows-2.webp", "/model/bg3.webp", "/model/bg2.webp",
  "/model/bg1.webp", "/model/glows.webp", "/model/bg3.webp", "/model/bg2.webp",
  "/model/bg1.webp", "/model/glows.webp", "/model/bg3.webp", "/model/bg2.webp",
  "/model/bg2.webp", "/model/bg3.webp", "/model/glows.webp", "/model/bg1.webp",
];
...
function App() {
  ...
  useEffect(() => {
    ...
    borderTimeline
      .to(".page-border .line.top, .page-border .line.bottom", { scaleX: 1, opacity: 1, duration: 1.2, ease: "power2.out" })
      .to(".page-border .line.left, .page-border .line.right", { scaleY: 1, opacity: 1, duration: 1.2, ease: "power2.out" }, "<0.3")
  ...
  return (
    <div className="main-app-container">
      ...
      {/* Scroll Content */}
      <div ref={scrollContainerRef} className="main-scroll-container h-screen overflow-y-scroll snap-y snap-mandatory">
        <NavOverlay />
        ...
        <section className="scroll-section snap-start h-screen w-full flex items-center justify-center">
          <div className="relative top-[-20%] text-center text-white max-w-4xl px-6 flex flex-col items-center justify-center gap-8">
            <h2 className="title-text">Turn Ideas Into<br />Multi-Format Universes</h2>
            <TryVedButton />
            <img src="/model/arrow.webp" alt="Scroll Down" className="mt-6 w-8 h-8 arrDown" />
          </div>
        </section>
        ...
        <section className="scroll-section snap-start h-screen w-full flex items-center justify-center">
          <div className="text-center text-white max-w-3xl px-6">
            <h2 className="title-text mb-6">World's First AI-Native Studio<br />with Tokenized IP</h2>
            <p className="body-text opacity-90 leading-relaxed mb-12">
            ...
            <a href="#explore-ips" className="button-style">
              [ EXPLORE OUR IPS ] <span className="ml-2">▶</span>
            </a>
          </div>
        </section>

        {/* Sliding Tabs */}
        <section id="sliding-tabs-section" className="scroll-section snap-start h-screen flex items-center justify-center relative">
        ...
        <section className="scroll-section snap-start h-screen w-full flex items-center justify-center">
          <ArchDoorwayWrapper><FeatureSlider /></ArchDoorwayWrapper>
        </section>
        <section className="scroll-section snap-start h-screen flex items-center justify-center"><HeroSection2 /></section>
        <section className="scroll-section snap-start h-screen flex items-center justify-center"><WelcomeSection /></section>
      </div>
